$setglobal project EPA
$setglobal lab     07052021

*$call gdxmerge gdx\output_%project%-*.gdx output=gdx\output_%project%_merged.gdx
...
loop (MAP_ScenLOOP_ScenDims(AllScenLOOP,MacroScen,BioenScen,IEA_SCEN,REGION),
 ...
 put_utilities Results_SCEN 'gdxin' / '.\gdx\output_%project%-'AllScenLOOP.tl ;
...
execute_unload '.\gdx\LAND_SU_%project%_%lab%.gdx'  LandCover_G4MID_SCEN ;
