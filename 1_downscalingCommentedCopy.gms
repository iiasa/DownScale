...
$setglobal project trunk
$setglobal lab     10052019
...
$include set_simU_reg_map_updated.gms
...
TABLE POP(SimUID,ATTRIBUTE2) pop density
$ondelim
...
****************************
*Planted forest is not availble in 2000, therefore, has to be initialised
...
EQUATIONS
ENTROPY_EQU
*Tis equation defines cross-enthropy
INTERMEq1
*******************************
...
*This is the main cross-enthropy equation, it is included in ENTROPY_EQU.. below
INTERMEq1(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)$( (NOT sameas(LC_TYPES_EPIC1,LC_TYPES_EPIC2)) AND
 (SH1(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)) AND (DDelta(LC_TYPES_EPIC1,LC_TYPES_EPIC2) >0)) ..
   INTERM1_VAR(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)
   =E=
   X_VAR(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)*LOG(X(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID) +delta)
   -X_VAR(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)*LOG(SH1(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID) + delta)  ;
...
Land_Positive_SU_EQU(LC_TYPES_EPIC,rSimUID)
  ...
  - SUM(LC_TYPES_EPIC2
    ...
    X_VAR(LC_TYPES_EPIC,LC_TYPES_EPIC2,rSimUID) * DDelta(LC_TYPES_EPIC,LC_TYPES_EPIC2))
...
Delta_Land_00_EQU(LC_TYPES_EPIC1)
    ...
    X_VAR(LC_TYPES_EPIC2,LC_TYPES_EPIC1,rSimUID) * DDelta(LC_TYPES_EPIC2,LC_TYPES_EPIC1)
         $(SH1(LC_TYPES_EPIC2,LC_TYPES_EPIC1,rSimUID))

  - X_VAR(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID) * DDelta(LC_TYPES_EPIC1,LC_TYPES_EPIC2)
         $(SH1(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID)) )
    =E=
    ...
    SUM(LC_TYPES_EPIC2
      $((NOT sameas (LC_TYPES_EPIC2,LC_TYPES_EPIC1)) AND
        (DDelta(LC_TYPES_EPIC2,LC_TYPES_EPIC1) > 0)),
    DDelta(LC_TYPES_EPIC2,LC_TYPES_EPIC1) - DDelta(LC_TYPES_EPIC1,LC_TYPES_EPIC2));
...
*Calculate Delta_fin as sum over all simulation units  X_VAR.l(LC_TYPES_EPIC1,LC_TYPES_EPIC2,rSimUID) * DDelta(LC_TYPES_EPIC1,LC_TYPES_EPIC2)
...
*Land transfered from type LC_TYPES_EPIC1 to type LC_TYPES_EPIC2, at the level of SimUID
...
*Land transfered from type LC_TYPES_EPIC1 to type LC_TYPES_EPIC2, at the level of REGION
Delta_LAND_Region(REGION,LC_TYPES_EPIC1,ScenYear)
 = SUM(rSimUID
         $(Delta_LAND(LC_TYPES_EPIC1,rSimUID,ScenYear)>0),
   Delta_LAND(LC_TYPES_EPIC1,rSimUID,ScenYear));

*Total land of type LC_TYPES_EPIC1 in SimUID after land tranformations
Land_Cover_SU(rSimUID,LC_TYPES_EPIC1)
 = Land_Cover_SU(rSimUID,LC_TYPES_EPIC1)
 + Delta_LAND(LC_TYPES_EPIC1,rSimUID,ScenYear);

*Total land in SimUID after all land transformations
SimUnitArea(rSimUID)
 = SUM(LC_TYPES_EPIC1
     $(NOT sameas(LC_TYPES_EPIC1,'SimUarea')),
   Land_Cover_SU(rSimUID,LC_TYPES_EPIC1));
...
* Used to Check total land in SimUID after all transformations to be equal to original total
sum_Land_Cover_tt_after(REGION,LC_TYPES_EPIC,ScenYear)
 = SUM(rSimUID, Land_Cover_SU(rSimUID,LC_TYPES_EPIC));

* Used to Track the dynamics of total land in SimUID
...
$include set_g4mIDsimUIDmap.gms
